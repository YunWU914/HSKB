...
- **Category Navigation**: Clear equipment classification system
- **Article List**: Displays the latest technical articles
- **Article Detail**: Detailed technical article content
- **Smooth Scrolling**: Smooth page interaction experience
...
Open `index.html` directly in your browser to access the website.
